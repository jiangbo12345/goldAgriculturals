...
<body scroll=no>
	...
	<div class="left" style="position: fixed;">
		<a href="#stage1" class="btu_top"></a> <a href="#stage1" class="home"></a>
	...
	<div id="cont">
		...
		<div class="stage" id="stage1"
			style="background-image: url(content/static/images/bg.jpg)">
		...
		<div class="stage" id="stage2" name="refresh"
			style="background-image: url(content/static/images/bg02.jpg)">
			<!--导航栏-->
			<div class="nav"
				...
				<li><a href="#stage1">首&nbsp;&nbsp;&nbsp;&nbsp;页</a></li>
			</div>
		</div>
        
		<div class="news"
			style="height:460px;top:60%; *top:114%; position:absolute; *position:fixed; margin:0 auto; padding:0;">
			<li
...
setTimeout(function(){EX.addEvent.call(document,'click',hide);});
		...
		<!--肥料产品选择-->
      <div class="friend_box" name="second" style="top:80%;">
        <div  class="friend">
