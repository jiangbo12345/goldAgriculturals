...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div  style="top:0; right:0; _position:fixed; width:75px; height:100%; position:absolute;">
      ...
      <div class="quick_links_panel" >
        ...
        <div class="quick_weixin_toggle" >
          <li id="div2"> <!--微信扫码--> 
            ...
            <div class="mp_qrcode"><img src="content/static/images/weixin_code_145.png"/></div>
          </li>
          <li class="language" id="div3" onmouseover="f1()" onmouseout="f2()" style="top:0px;"><!--语言选择id="div3"--> 
